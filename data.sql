...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('4', TRUE, '2023-07-04 19:26:48', 'What does a ViewResolver do?', 45, 1, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('5', TRUE, '2023-07-04 19:26:48', 'How are Spring Data repositories implemented by Spring at runtime?', 45, 2, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('6', TRUE, '2023-07-04 19:26:48', 'What is SpEL and how is it used in Spring?', 45, 1, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('7', TRUE, '2023-07-04 19:26:48', 'The process of linking aspects with other objects to create an advised object is called', 45, 1, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('8', TRUE, '2023-07-04 19:26:48', 'How are JDK Dynamic proxies and CGLIB proxies used in Spring?', 45, 4, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('9', TRUE, '2023-07-04 19:26:48', 'Which of these is not a valid method on the JoinPoint interface?', 45, 1, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('10', TRUE, '2023-07-04 19:26:48', 'In what order do the @PostConstruct annotated method, the init-method parameter method on beans and the afterPropertiesSet() method execute?', 45, 4, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('11', TRUE, '2023-07-04 19:26:48', 'What is the function of the `@Transactional` annotation at the class level?', 45, 2, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('14', TRUE, '2023-07-04 19:26:48', 'What is the root interface for accessing a Spring bean container?', 45, 1, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('15', TRUE, '2023-07-04 19:26:48', 'Which annotation can be used within Spring Security to apply method level security?', 45, 1, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('17', TRUE, '2023-07-04 19:26:48', 'What is the purpose of the @Lazy annotation and why would you use it?', 45, 3, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('18', TRUE, '2023-07-04 19:26:48', 'What is dependency injection?', 45, 3, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('19', TRUE, '2023-07-04 19:26:48', 'What is a RESTful web service?', 45, 3, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('20', TRUE, '2023-07-04 19:26:48', 'What happens when a class is annotated with the @Controller annotation?', 45, 1, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('21', TRUE, '2023-07-04 19:26:48', 'Which property can be used to change the port of a Spring application?', 45, 1, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('22', TRUE, '2023-07-04 19:26:48', 'What is the purpose of the @ResponseBody annotation?', 45, 3, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('23', TRUE, '2023-07-04 19:26:48', 'How are mocking frameworks such as Mockito used with Spring?', 45, 3, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('24', TRUE, '2023-07-04 19:26:48', 'What is the name of the central servlet that dispatches requests to controllers?', 45, 1, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('25', TRUE, '2023-07-04 19:26:48', 'What is the purpose of the Spring IoC (Inversion of Control) container?', 45, 1, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('26', TRUE, '2023-07-04 19:26:48', 'What is component scanning?', 45, 1, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('27', TRUE, '2023-07-04 19:26:48', 'What does @SpringBootApplication do?', 45, 1, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('28', TRUE, '2023-07-04 19:26:48', 'How does Spring Data facilitate queries against a datastore?', 45, 2, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('29', TRUE, '2023-07-04 19:26:48', 'How does Spring generate bean names for classes annotated with @Component that do not specify a name?', 45, 1, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('30', TRUE, '2023-07-04 19:26:48', 'What is the delegating filter proxy?', 45, 3, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('31', TRUE, '2023-07-04 19:26:48', 'What value does Spring Boot Actuator provide?', 45, 1, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('32', TRUE, '2023-07-04 19:26:48', 'What is the purpose of the @ContextConfiguration annotation in a JUnit Test?', 45, 2, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('33', TRUE, '2023-07-04 19:26:48', 'How are authentication and authorization different?', 45, 2, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('34', TRUE, '2023-07-04 19:26:48', 'What is the purpose of the @RequestBody annotation?', 45, 2, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('35', TRUE, '2023-07-04 19:26:48', 'What is the DispatcherServlet and what is its function?', 45, 2, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('36', TRUE, '2023-07-04 19:26:48', 'What is Spring Boot autoconfiguration?', 45, 4, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('37', TRUE, '2023-07-04 19:26:48', 'Which are valid steps to take to enable JPA in Spring Boot?', 45, 2, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('38', TRUE, '2023-07-04 19:26:48', 'What is a transaction in the context of Spring Data?', 45, 4, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('39', TRUE, '2023-07-04 19:26:48', 'Modularization of a concern that cuts across multiple classes is known as a(n)`____`.', 45, 4, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('40', TRUE, '2023-07-04 19:26:48', 'How do you inject a dependency into a Spring bean?', 45, 3, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('42', TRUE, '2023-07-04 19:26:48', 'What is a bean in the context of Spring?', 45, 2, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('43', TRUE, '2023-07-04 19:26:48', 'Which property is given precedence by Spring?', 45, 4, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('44', TRUE, '2023-07-04 19:26:48', 'In the Spring Bean lifecycle pictured, what should the third step of the process be?', 45, 4, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('45', TRUE, '2023-07-04 19:26:48', 'What Spring Boot property is used to set the logging level for the entire application in the application.properties file?', 45, 4, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('46', TRUE, '2023-07-04 19:26:48', 'What is a Spring bean uniquely identified?', 45, 3, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('47', TRUE, '2023-07-04 19:26:48', 'What is the difference between a JAR and a WAR distribution in Spring Boot?', 45, 3, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('48', TRUE, '2023-07-04 19:26:48', 'How does the transaction propagation setting impact the behavior of transactions?', 45, 3, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('50', TRUE, '2023-07-04 19:26:48', 'To register a custom filter that applies only to certain URL patterns, you should remove the **\_** annotation from the filter class and register a @Bean of type `_` in Spring @Configuration.', 45, 1, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('52', TRUE, '2023-07-04 19:26:48', 'How should passwords be stored?', 45, 1, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('53', TRUE, '2023-07-04 19:26:48', 'What methods does this Pointcut expression reference?', 45, 2, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('55', TRUE, '2023-07-04 19:26:48', 'What is the purpose of a web application context?', 45, 3, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('56', TRUE, '2023-07-04 19:26:48', 'What is Spring AOP?', 45, 4, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('57', TRUE, '2023-07-04 19:26:48', 'Assuming username and password authentication is in place, what method on the Authentication object can be used to obtain the username?', 45, 2, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('58', TRUE, '2023-07-04 19:26:48', 'Assuming no additional configuration is provided, what is the first selection criteria Spring uses to choose a bean when autowiring a property?', 45, 2, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('61', TRUE, '2023-07-04 19:26:48', 'What is a security context?', 45, 1, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('62', TRUE, '2023-07-04 19:26:48', 'How might you map an incoming request to a controller method?', 45, 2, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('63', TRUE, '2023-07-04 19:26:48', 'What methods does the Pointcut expression below reference?', 45, 1, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('64', TRUE, '2023-07-04 19:26:48', 'What pattern does Spring MVC implement to delegate request processing to controllers?', 45, 4, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('65', TRUE, '2023-07-04 19:26:48', 'What methods does this Pointcut expression?', 45, 1, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('66', TRUE, '2023-07-04 19:26:48', 'What is the output from invoking this Actuator endpoint in an unmodified Spring Boot application generated using Spring Intializr?', 45, 2, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('67', TRUE, '2023-07-04 19:26:48', 'How can you access the application context in a Spring integration test?', 45, 4, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('68', TRUE, '2023-07-04 19:26:48', 'What interface can be specified as a parameter in a controller method signature to handle file uploads?', 45, 4, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('70', TRUE, '2023-07-04 19:26:48', 'What property can be used to set the active Spring profiles', 45, 4, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('71', TRUE, '2023-07-04 19:26:48', 'Which statement is true regarding loading and instantiation of Spring factories?', 45, 3, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('73', TRUE, '2023-07-04 19:26:48', 'When configuring an application, which configuration is given precedence by Spring?', 45, 3, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('74', TRUE, '2023-07-04 19:26:48', 'What interface is used to represent a permission in Spring Security?', 45, 1, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('75', TRUE, '2023-07-04 19:26:48', 'What is the difference between constructor injection and setter injection?', 45, 3, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('77', TRUE, '2023-07-04 19:26:48', 'What is the default rollback policy?', 45, 4, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('78', TRUE, '2023-07-04 19:26:48', 'What is the difference between a CrudRepository and a JpaRepository?', 45, 2, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('79', TRUE, '2023-07-04 19:26:48', 'What is the security filter chain?', 45, 4, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('80', TRUE, '2023-07-04 19:26:48', 'Which is not a valid stereotype annotation?', 45, 2, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('81', TRUE, '2023-07-04 19:26:48', 'Which statement is true regarding loading and instantiation of Spring factories?', 45, 2, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('83', TRUE, '2023-07-04 19:26:48', 'What is a transaction isolation level?', 45, 4, 1);
...
INSERT INTO public.question (id, is_reported, last_update, statement, timer, skill_level_id, skill_theme_id) VALUES
('84', TRUE, '2023-07-04 19:26:48', 'What does the statement "Spring offers fully-typed advice" mean?', 45, 3, 1);
